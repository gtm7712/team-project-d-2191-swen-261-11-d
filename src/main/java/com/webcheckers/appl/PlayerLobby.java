...
/**
 * Application tier, controls and holds who is logged in, and if names are valid to be logged in
 *
 */
public class PlayerLobby {
    private HashMap<String, Player> loggedIn=new HashMap<>();  //logged in people

    private final String INVALID_USERNAME= "This username is not Alphanumeric!";
    private final String USERNAME_IN_USE = "Pick another username this one is already used";
    private final String USERNAME_GOOD = "Logged in";

    /**
     *Checks if a username is valid
     * @param username
     * @return String that says if your username is good or not and why if it is not good
     */
