...
/**
 * Unit test suite for {@link GetReplayNext} component
 * 
 * @author Brandon Chen
 */
@Tag("UI-tier")
public class GetReplayNextTest{

    private GetReplayNextRoute CuT;
    ...
    /**
     * setup for the replay next test
     */
    @BeforeEach
    public void setup(){
        ...
        CuT = new GetReplayNextRoute(gson, gameList);
    }
